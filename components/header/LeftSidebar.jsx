...
function LeftSidebar({ isOpen, toggleSidebar }) {
  ...
  return (
    <div
      ref={sidebarRef}
      className={`fixed top-0 left-0 h-[270px] 3xl:h-[370px] w-[180px] sm:w-[218px] 3xl:w-[328px] bg-black tracking-[2.5px] text-white transition-transform duration-300 z-50 ${
